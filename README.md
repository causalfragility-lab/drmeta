...
<!-- badges: start -->
[![R-CMD-check](https://github.com/subirhait/drmeta/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/subirhait/drmeta/actions/workflows/R-CMD-check.yaml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
<!-- badges: end -->

## Design-Robust Meta-Analysis: A Variance-Function Framework for Causal Credibility

**drmeta** implements the DR-Meta model of Hait (2025) — a
...
So study weights $w_i = 1/\sigma_i^2$ automatically down-weight weaker
...
dr <- dr_score(balance = c(0.9, 0.6, 0.3, 0.8, 0.5),
...
# 4. Diagnostics
dr_heterogeneity(fit)   # Q, I^2, Proposition 6 decomposition
